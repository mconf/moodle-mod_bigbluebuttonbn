...
$string['bbburl'] = 'The URL of your Mconf server must end with /bigbluebutton/. (This default URL is for a BigBlueButton server provided by Blindside Networks that you can use for testing.)';
...
$string['bigbluebuttonbnintro'] = 'Mconf Intro';
$string['bigbluebuttonbnSalt'] = 'Mconf Shared Secret';
$string['bigbluebuttonbnDetectMobile'] = 'Detect Mobile Clients';
$string['bigbluebuttonbnForceMobile'] = 'Force Mobile Client';
$string['bigbluebuttonbnUrl'] = 'Mconf Server URL';
$string['bigbluebuttonbnWait'] = 'User has to wait';
$string['configsecuritysalt'] = 'The security salt of your Mconf server.  (This default salt is for a BigBlueButton server provided by Blindside Networks that you can use for testing.)';
$string['detectmobile'] = 'Try to detect if the conference is being accessed from a mobile device and redirect to mobile client';
$string['forcemobile'] = 'Don\'t try to detect mobile clients and always force joining the conference as mobile';
...
$string['mod_form_field_newwindow'] = 'Open Mconf in a new window';
...
$string['mod_form_field_welcome_default'] = '<br>Welcome to <b>%%CONFNAME%%</b>!<br><br>To join the audio bridge click the headset icon (upper-left hand corner). <b>Please use a headset to avoid causing noise for others.</b>';
