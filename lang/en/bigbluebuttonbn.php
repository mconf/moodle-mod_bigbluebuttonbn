...
$string['mod_form_field_description'] = 'Recording description';
$string['mod_form_field_description_help'] = 'A short description of the recording session that will be shown in the recording list. Can be different for each session.';
