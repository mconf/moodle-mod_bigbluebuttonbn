...
$string['mod_form_field_duration_help'] = 'Marcar a duração máxima para uma webconferência irá estabelecer o tempo máximo para que a sala fique ativa antes da gravação encerrar.';
